...
pub async fn setup_superuser(
    ...
    if netidx_admin_proto::policy::is_reserved_admin(&name) {
        bail!(
...
/// Assemble a [`Policy`](netidx_admin_proto::policy::Policy) from the flag-supplied
...
pub async fn gather_policy(
    ...
    cn: &str,
    domain: Option<&str>,
) -> Result<netidx_admin_proto::policy::Policy> {
    ...
    Ok(netidx_admin_proto::policy::Policy {
        allowed_san,
