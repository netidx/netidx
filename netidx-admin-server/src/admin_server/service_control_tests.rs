use super::*;
use crate::admin_proto::{AdminServerEntry, Role};
...
fn service_control_routing_uses_identity_across_address_reuse() {
    ...
    map.admin_servers.push(entry(replacement, old_addr));
    ...
    map.admin_servers[0].state = admin_proto::ServerState::Enrolled;
