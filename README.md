...
subscribe to live data across your admin domain using a simple,
...
- Encryption for all admin domain traffic
...
- **IoT admin domains** - Hierarchically organized device data with discovery
...
**Maybe not:**
- You want complex event processing/filtering (the admin domain is not a database)
...
- **Admin domain Event logging** - Capture all updates to subscribed paths to disk
