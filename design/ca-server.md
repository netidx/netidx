...
netidx-conf/src/
  ...
  ca/client.rs     NEW — the join client: rcgen CSR, TOFU connect, fingerprint-confirm, request (cross-platform)
  fingerprint.rs   NEW — sha2 + identicon, openssl-free (used by both sides + the CLI)
