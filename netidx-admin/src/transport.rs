...
pub async fn enroll(
    ...
    resolver_config: Option<netidx::resolver_server::config::file::Config>,
...
mod tests {
    ...
    async fn hostile_satellite(
        ...
        let hostile_map = AdminDomainMap {
            ...
            version: 1,
            ca: server_id,
            admin_servers: vec![AdminServerEntry::granted(
                server_id,
                addr,
        ...
        let map = AdminDomainMap {
            ...
            admin_servers: vec![
                AdminServerEntry::granted(
                    ca,
                    "192.168.50.11:4565".parse().unwrap(),
                    Role::Ca.into(),
                    None,
                    None,
                    ServerState::Registered,
                ...
                AdminServerEntry::granted(
                    root_server,
                    "192.168.50.10:4565".parse().unwrap(),
                    Role::Resolver.into(),
                    Some(root.clone()),
                    Some(root_cluster),
                    ServerState::Registered,
                ...
                AdminServerEntry::granted(
                    waiting,
                    "192.168.50.12:4565".parse().unwrap(),
                    Role::Resolver.into(),
                    Some(waiting_root.clone()),
                    Some(root_cluster),
                    ServerState::Enrolled,
                ),
                AdminServerEntry::granted(
                    satellite,
                    "192.168.60.15:4565".parse().unwrap(),
                    Role::Resolver.into(),
                    Some(child.clone()),
                    Some(child_cluster),
                    ServerState::Registered,
